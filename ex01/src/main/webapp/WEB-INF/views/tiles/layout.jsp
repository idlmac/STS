...
<body>
	...
	<footer>
		...
		<div id="footerBox">
			<div id="downQuickBox">
				<div id="downQuick">
					<a href="/" title="Home">HOME</a><a href="/SUB/?ctId=13"
						title="개인정보취급방침"><span class="bold">개인정보취급방침</span></a><a
						href="/BBS/msList.php?tId=entrance" title="온라인 입학상담">온라인 입학상담</a><a
						href="/SUB/?ctId=53" class="last" title="오시는 길">오시는 길</a>
				</div>
			</div>
			<div id="footer">
				<h2 class="skip">카피라이트</h2>
				<div id="flogo">
					<img src="/DATA/DEFAULT/7cfd74912cf31d1881b50fecad1345730.png"
						class="valignM" alt="(주)예담직업전문학교" />
				</div>
				<div id="address">
					<address>
